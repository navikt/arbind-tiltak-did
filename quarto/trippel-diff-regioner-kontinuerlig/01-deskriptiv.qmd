...
- Antall enheter: **12**
- Antall måneder: **60**
- Behandlet gruppe (trenger-veiledning, n): **720**
- Kontrollgruppe (gode-muligheter, n): **720**

**Gjennomsnittlig indikatorverdi i pre-perioden:**

| Gruppe | Gjennomsnitt |
|:--|--:|
| trenger-veiledning (behandlet) | -0.0834 |
| gode-muligheter (kontroll) | 0.9725 |
| Differanse | -1.0559 |

I pre-perioden lå trenger-veiledning i gjennomsnitt **1.0559** poeng
...
| Gruppe | Gjennomsnitt |
|:--|--:|
| trenger-veiledning (behandlet) | 0.0409 |
| gode-muligheter (kontroll) | 2.8985 |
| Differanse | -2.8576 |

I pre-perioden lå trenger-veiledning i gjennomsnitt **2.8576** poeng
