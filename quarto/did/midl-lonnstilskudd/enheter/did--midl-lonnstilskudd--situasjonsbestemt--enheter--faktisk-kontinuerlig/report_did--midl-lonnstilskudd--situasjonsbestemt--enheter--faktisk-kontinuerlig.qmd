---
title: "DiD | Midl. lønnstilskudd | Situasjonsbestemt | Faktisk | Kontinuerlig (Enheter)"
execute:
  echo: false
  warning: false
---
...
|:---------------------|---------------:|------------:|--------:|---------:|
| atid3                |         10.65  |       2.702 |   1.963 |   25.303 |
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        0.2616 |           0.4838 |    0.541 |           0.608 |            0.5995 | [-0.8032, 1.3263] |  12942 |         12 |
| Sesongjustert |       -0.0606 |           0.4752 |   -0.127 |           0.907 |            0.9009 | [-1.1066, 0.9854] |  12903 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 10.7 % — koeffisienten tilsvarer en relativ endring på -0.6 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±1.46 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(11,11) = 3385.08, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er 1.0384 (p = 0.366). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
...
Sesongjustert modell: koeffisienten varierer mellom -0.2941 til 0.6396 når én region utelates.
...
|                      |   Gjennomsnitt |   Std.avvik |     Min |     Maks |
|:---------------------|---------------:|------------:|--------:|---------:|
| jobb3                |         28.615 |       7.715 |  -8.286 |   82.406 |
| Tiltaksnedgang (0–1) |          0.046 |       0.152 |   0     |    0.783 |
| Tiltak (antall)      |        595.882 |     243.948 | 133     | 1222     |
...
| Modell        |   Koeffisient |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        0.761  |           1.2006 |    0.634 |           0.558 |            0.5391 | [-1.8815, 3.4035] |  12942 |         12 |
| Sesongjustert |       -0.0584 |           1.0951 |   -0.053 |           0.96  |            0.9584 | [-2.4686, 2.3518] |  12903 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 28.8 % — koeffisienten tilsvarer en relativ endring på -0.2 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±3.37 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(11,11) = 922.62, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er 3.5052 (p = 0.216). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
...
Sesongjustert modell: koeffisienten varierer mellom -0.6306 til 1.5461 når én region utelates.
