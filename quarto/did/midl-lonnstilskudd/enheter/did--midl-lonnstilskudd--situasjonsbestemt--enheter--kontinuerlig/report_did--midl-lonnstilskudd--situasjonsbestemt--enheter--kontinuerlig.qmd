---
title: "DiD | Midl. lønnstilskudd | Situasjonsbestemt | Kontinuerlig (Enheter)"
execute:
  echo: false
  warning: false
---
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        0.2601 |           0.1569 |    1.657 |           0.14  |            0.1257 | [-0.0854, 0.6055] |  12942 |         12 |
| Sesongjustert |       -0.1812 |           0.2922 |   -0.62  |           0.588 |            0.5479 | [-0.8243, 0.4620] |  12903 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 0.3 % — koeffisienten tilsvarer en relativ endring på -56.3 %.  
...
**Advarsel:** pre-trend-testen er signifikant (F(11,11) = 245.67, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -0.5660 til 0.0422 når én region utelates.
...
| Modell        |   Koeffisient |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        0.763  |           0.5241 |    1.456 |           0.147 |            0.1734 | [-0.3905, 1.9166] |  12942 |         12 |
| Sesongjustert |       -0.4502 |           0.9289 |   -0.485 |           0.647 |            0.6375 | [-2.4947, 1.5943] |  12903 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 1.5 % — koeffisienten tilsvarer en relativ endring på -30.7 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±2.86 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(11,11) = 721.21, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -1.7281 til 0.1746 når én region utelates.
