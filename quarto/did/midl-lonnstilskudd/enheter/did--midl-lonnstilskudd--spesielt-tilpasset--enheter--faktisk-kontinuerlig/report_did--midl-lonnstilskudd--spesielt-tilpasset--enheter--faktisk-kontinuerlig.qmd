---
title: "DiD | Midl. lønnstilskudd | Spesielt tilpasset | Faktisk | Kontinuerlig (Enheter)"
execute:
  echo: false
  warning: false
---
...
| Tiltak (antall)      |        588.938 |     244.953 | 133     | 1222     |
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |       -0.0066 |           0.1695 |   -0.039 |           0.967 |            0.9698 | [-0.3797, 0.3666] |  14370 |         12 |
| Sesongjustert |       -0.1068 |           0.19   |   -0.562 |           0.573 |            0.5854 | [-0.5250, 0.3115] |  14369 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 7.1 % — koeffisienten tilsvarer en relativ endring på -1.5 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±0.58 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(11,11) = 6436.35, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er -2.6122 (p = 0.000). **Advarsel:** placebo-estimatet er signifikant, noe som kan indikere pre-eksisterende trender.
...
Sesongjustert modell: koeffisienten varierer mellom -0.2677 til 0.0069 når én region utelates.
...
| Modell        |   Koeffisient |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        0.3611 |           0.4548 |    0.794 |           0.428 |            0.444  | [-0.6398, 1.3620] |  14370 |         12 |
| Sesongjustert |       -0.0455 |           0.5107 |   -0.089 |           0.926 |            0.9306 | [-1.1696, 1.0785] |  14369 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 16.6 % — koeffisienten tilsvarer en relativ endring på -0.3 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±1.57 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(11,11) = 516.49, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er -8.6379 (p = 0.000). **Advarsel:** placebo-estimatet er signifikant, noe som kan indikere pre-eksisterende trender.
...
Sesongjustert modell: koeffisienten varierer mellom -0.4195 til 0.2586 når én region utelates.
