---
title: "DiD | Midl. lønnstilskudd | Standard | Faktisk | Kontinuerlig (Enheter)"
execute:
  echo: false
  warning: false
---
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        0.4173 |           0.5445 |    0.766 |           0.496 |            0.4596 | [-0.7811, 1.6158] |  12139 |         12 |
| Sesongjustert |        0.0101 |           0.6604 |    0.015 |           0.985 |            0.988  | [-1.4434, 1.4637] |  12136 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 14.3 % — koeffisienten tilsvarer en relativ endring på 0.1 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±2.03 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(11,11) = 1674.58, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -1.0054 til 0.3127 når én region utelates.
...
| Modell        |   Koeffisient |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        1.3642 |           1.4064 |     0.97 |           0.377 |            0.3529 | [-1.7312, 4.4596] |  12139 |         12 |
| Sesongjustert |        0.1593 |           1.7678 |     0.09 |           0.917 |            0.9298 | [-3.7316, 4.0503] |  12136 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 39.3 % — koeffisienten tilsvarer en relativ endring på 0.4 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±5.44 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(11,11) = 70.83, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -1.9994 til 1.2063 når én region utelates.
