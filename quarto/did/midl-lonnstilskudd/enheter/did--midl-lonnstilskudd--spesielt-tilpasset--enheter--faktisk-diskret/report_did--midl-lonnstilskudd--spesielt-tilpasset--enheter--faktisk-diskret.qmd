---
title: "DiD | Midl. lønnstilskudd | Spesielt tilpasset | Faktisk | Diskret (Enheter)"
execute:
  echo: false
  warning: false
---
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        0.1069 |           0.1302 |    0.821 |           0.624 |             0.429 | [-0.1797, 0.3935] |  14370 |         12 |
| Sesongjustert |        0.103  |           0.138  |    0.747 |           0.648 |             0.471 | [-0.2007, 0.4067] |  14369 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 7.1 % — koeffisienten tilsvarer en relativ endring på 1.4 %.  
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 21.61, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -0.0482 til 0.3073 når én region utelates.
...
| Modell        |   Koeffisient |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        0.4828 |           0.2624 |    1.84  |           0.111 |            0.0929 | [-0.0947, 1.0604] |  14370 |         12 |
| Sesongjustert |        0.4303 |           0.2987 |    1.441 |           0.167 |            0.1776 | [-0.2271, 1.0876] |  14369 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 16.6 % — koeffisienten tilsvarer en relativ endring på 2.6 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±0.92 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 13.41, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom 0.1161 til 0.8550 når én region utelates.
