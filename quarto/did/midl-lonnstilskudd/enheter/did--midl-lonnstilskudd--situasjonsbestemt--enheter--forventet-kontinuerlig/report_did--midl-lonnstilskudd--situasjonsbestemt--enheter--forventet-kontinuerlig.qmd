---
title: "DiD | Midl. lønnstilskudd | Situasjonsbestemt | Forventet | Kontinuerlig (Enheter)"
execute:
  echo: false
  warning: false
---
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        0.0014 |           0.4232 |    0.003 |           0.997 |            0.9974 | [-0.9300, 0.9328] |  12942 |         12 |
| Sesongjustert |        0.1204 |           0.5843 |    0.206 |           0.87  |            0.8405 | [-1.1657, 1.4065] |  12903 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 10.4 % — koeffisienten tilsvarer en relativ endring på 1.2 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±1.80 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(11,11) = 4307.53, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er 0.7456 (p = 0.435). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
...
Sesongjustert modell: koeffisienten varierer mellom -0.0665 til 1.2055 når én region utelates.
...
|                      |   Gjennomsnitt |   Std.avvik |    Min |     Maks |
|:---------------------|---------------:|------------:|-------:|---------:|
| jobb3                |         27.265 |       5.144 |  11.64 |   64.917 |
| Tiltaksnedgang (0–1) |          0.046 |       0.152 |   0    |    0.783 |
| Tiltak (antall)      |        595.882 |     243.948 | 133    | 1222     |
...
| Modell        |   Koeffisient |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        0.0042 |           1.0767 |    0.004 |           0.996 |            0.997  | [-2.3655, 2.3739] |  12942 |         12 |
| Sesongjustert |        0.3962 |           1.514  |    0.262 |           0.842 |            0.7984 | [-2.9360, 3.7285] |  12903 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 27.4 % — koeffisienten tilsvarer en relativ endring på 1.4 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±4.66 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(11,11) = 3047.63, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er 2.4839 (p = 0.333). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
...
Sesongjustert modell: koeffisienten varierer mellom -0.0772 til 3.2710 når én region utelates.
