---
title: "DiD | Midl. lønnstilskudd | Veiledning kombinert | Faktisk | Kontinuerlig (Enheter)"
execute:
  echo: false
  warning: false
---
...
|:--------------|:--------------|-----------------:|---------:|----------------:|------------------:|:-------------------|-------:|-----------:|
| Basis         | -0.2726       |           0.1036 |   -2.631 |           0.17  |            0.0234 | [-0.5006, -0.0445] |  12928 |         12 |
| Sesongjustert | -0.4329*      |           0.1285 |   -3.369 |           0.079 |            0.0063 | [-0.7157, -0.1501] |  12885 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 8.1 % — koeffisienten tilsvarer en relativ endring på -5.3 %.  
...
**Advarsel:** pre-trend-testen er signifikant (F(11,11) = 65.46, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er -0.6249 (p = 0.102). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
...
Sesongjustert modell: koeffisienten varierer mellom -0.4888 til -0.3404 når én region utelates.
...
| Modell        |   Koeffisient |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI             |   Obs. |   Clustere |
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:-------------------|-------:|-----------:|
| Basis         |       -0.7966 |           0.3467 |   -2.298 |           0.179 |            0.0422 | [-1.5596, -0.0336] |  12928 |         12 |
| Sesongjustert |       -1.3086 |           0.4402 |   -2.973 |           0.103 |            0.0127 | [-2.2775, -0.3398] |  12885 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 19.9 % — koeffisienten tilsvarer en relativ endring på -6.6 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±1.35 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(11,11) = 204.81, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er -2.0535 (p = 0.055). **Advarsel:** placebo-estimatet er signifikant, noe som kan indikere pre-eksisterende trender.
...
Sesongjustert modell: koeffisienten varierer mellom -1.4791 til -1.0316 når én region utelates.
