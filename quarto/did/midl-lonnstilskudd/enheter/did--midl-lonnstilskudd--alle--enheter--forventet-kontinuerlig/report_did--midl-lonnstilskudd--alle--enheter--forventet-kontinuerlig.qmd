---
title: "DiD | Midl. lønnstilskudd | Alle | Forventet | Kontinuerlig (Enheter)"
execute:
  echo: false
  warning: false
---
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |       -0.2734 |           0.2043 |   -1.338 |           0.455 |            0.2078 | [-0.7232, 0.1763] |  14643 |         12 |
| Sesongjustert |       -0.1722 |           0.2951 |   -0.583 |           0.746 |            0.5713 | [-0.8217, 0.4773] |  14643 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 9.2 % — koeffisienten tilsvarer en relativ endring på -1.9 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±0.91 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(11,11) = 20407.72, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -0.3732 til 0.2930 når én region utelates.
...
| Modell        |   Koeffisient |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |       -0.6851 |           0.4042 |   -1.695 |           0.288 |            0.1182 | [-1.5748, 0.2046] |  14643 |         12 |
| Sesongjustert |       -0.3695 |           0.6992 |   -0.528 |           0.793 |            0.6077 | [-1.9085, 1.1694] |  14643 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 22.8 % — koeffisienten tilsvarer en relativ endring på -1.6 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±2.15 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(11,11) = 25973.42, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -0.6918 til 0.7705 når én region utelates.
