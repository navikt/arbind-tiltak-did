---
title: "DiD | Midl. lønnstilskudd | Spesielt tilpasset | Forventet | Kontinuerlig (Enheter)"
execute:
  echo: false
  warning: false
---
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |       -0.1657 |           0.152  |   -1.091 |           0.354 |            0.2987 | [-0.5002, 0.1687] |  14370 |         12 |
| Sesongjustert |       -0.1352 |           0.1979 |   -0.683 |           0.54  |            0.5087 | [-0.5708, 0.3004] |  14369 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 7.4 % — koeffisienten tilsvarer en relativ endring på -1.8 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±0.61 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(11,11) = 5892.33, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er -1.5222 (p = 0.000). **Advarsel:** placebo-estimatet er signifikant, noe som kan indikere pre-eksisterende trender.
...
Sesongjustert modell: koeffisienten varierer mellom -0.3043 til 0.0296 når én region utelates.
...
| Modell        |   Koeffisient |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |       -0.1901 |           0.3085 |   -0.616 |           0.532 |            0.5503 | [-0.8691, 0.4889] |  14370 |         12 |
| Sesongjustert |       -0.1179 |           0.4129 |   -0.285 |           0.78  |            0.7806 | [-1.0266, 0.7909] |  14369 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 17.0 % — koeffisienten tilsvarer en relativ endring på -0.7 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±1.27 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(11,11) = 683.12, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er -3.4930 (p = 0.000). **Advarsel:** placebo-estimatet er signifikant, noe som kan indikere pre-eksisterende trender.
...
Sesongjustert modell: koeffisienten varierer mellom -0.3592 til 0.1283 når én region utelates.
