---
title: "DiD | Midl. lønnstilskudd | Standard | Faktisk | Kontinuerlig"
execute:
  echo: false
  warning: false
---
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        1.3897 |           0.9094 |    1.528 |           0.154 |            0.1547 | [-0.6120, 3.3914] |    720 |         12 |
| Sesongjustert |        0.7314 |           0.7486 |    0.977 |           0.351 |            0.3496 | [-0.9163, 2.3791] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 14.1 % — koeffisienten tilsvarer en relativ endring på 5.2 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±2.30 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 13.15, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom 0.1906 til 1.0167 når én region utelates.
...
| Modell        |   Koeffisient |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI             |   Obs. |   Clustere |
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:-------------------|-------:|-----------:|
| Basis         |        4.0101 |           2.8497 |    1.407 |           0.161 |            0.187  | [-2.2620, 10.2822] |    720 |         12 |
| Sesongjustert |        1.8795 |           2.3576 |    0.797 |           0.461 |            0.4422 | [-3.3094, 7.0685]  |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 38.8 % — koeffisienten tilsvarer en relativ endring på 4.8 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±7.25 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 2.93, p = 0.046), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -0.0435 til 3.0980 når én region utelates.
