---
title: "DiD | Midl. lønnstilskudd | Standard | Forventet | Kontinuerlig"
execute:
  echo: false
  warning: false
---
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        0.4276 |           0.6846 |    0.625 |           0.573 |            0.545  | [-1.0791, 1.9343] |    720 |         12 |
| Sesongjustert |        0.3027 |           0.5516 |    0.549 |           0.585 |            0.5942 | [-0.9114, 1.5167] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 13.2 % — koeffisienten tilsvarer en relativ endring på 2.3 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±1.70 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 6.33, p = 0.003), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -0.1015 til 0.6523 når én region utelates.
...
| Modell        |   Koeffisient |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        1.2451 |           1.836  |    0.678 |           0.524 |            0.5117 | [-2.7959, 5.2861] |    720 |         12 |
| Sesongjustert |        0.9382 |           1.5894 |    0.59  |           0.556 |            0.5669 | [-2.5600, 4.4365] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 36.2 % — koeffisienten tilsvarer en relativ endring på 2.6 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±4.89 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 4.59, p = 0.010), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -0.1481 til 2.0952 når én region utelates.
