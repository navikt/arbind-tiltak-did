---
title: "DiD | Midl. lønnstilskudd | Spesielt tilpasset | Kontinuerlig"
execute:
  echo: false
  warning: false
---
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        0.0479 |           0.0513 |    0.935 |           0.314 |            0.3699 | [-0.0649, 0.1607] |    720 |         12 |
| Sesongjustert |       -0.1063 |           0.0831 |   -1.278 |           0.163 |            0.2275 | [-0.2892, 0.0767] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** -0.2 % — koeffisienten tilsvarer en relativ endring på 50.9 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±0.26 pp.
...
Det er **ikke** statistisk grunnlag for å forkaste parallelle trender (F(10,11) = 2.07, p = 0.124, sesongjustert modell).
...
Sesongjustert modell: koeffisienten varierer mellom -0.2088 til -0.0807 når én region utelates.
...
| Modell        | Koeffisient   |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|:--------------|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         | 0.2897*       |           0.1341 |    2.159 |           0.075 |            0.0538 | [-0.0056, 0.5849] |    720 |         12 |
| Sesongjustert | -0.3241*      |           0.2203 |   -1.471 |           0.076 |            0.1692 | [-0.8089, 0.1607] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** -0.4 % — koeffisienten tilsvarer en relativ endring på 84.7 %.  
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 4.58, p = 0.010), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -0.5495 til -0.2460 når én region utelates.
