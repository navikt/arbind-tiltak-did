---
title: "DiD | Midl. lønnstilskudd | Veiledning kombinert | Faktisk | Kontinuerlig"
execute:
  echo: false
  warning: false
---
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:-------------------|-------:|-----------:|
| Basis         |       -0.3476 |           0.2501 |   -1.39  |           0.281 |            0.192  | [-0.8980, 0.2028]  |    720 |         12 |
| Sesongjustert |       -0.5801 |           0.2374 |   -2.444 |           0.144 |            0.0326 | [-1.1025, -0.0576] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 7.8 % — koeffisienten tilsvarer en relativ endring på -7.5 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±0.73 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 4.92, p = 0.007), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -0.6854 til -0.3891 når én region utelates.
...
| Modell        | Koeffisient   |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI             |   Obs. |   Clustere |
|:--------------|:--------------|-----------------:|---------:|----------------:|------------------:|:-------------------|-------:|-----------:|
| Basis         | -0.9318       |           0.6794 |   -1.371 |           0.288 |            0.1976 | [-2.4273, 0.5636]  |    720 |         12 |
| Sesongjustert | -1.7648*      |           0.6021 |   -2.931 |           0.099 |            0.0137 | [-3.0900, -0.4396] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 19.1 % — koeffisienten tilsvarer en relativ endring på -9.2 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±1.85 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 11.59, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -2.0447 til -1.3059 når én region utelates.
