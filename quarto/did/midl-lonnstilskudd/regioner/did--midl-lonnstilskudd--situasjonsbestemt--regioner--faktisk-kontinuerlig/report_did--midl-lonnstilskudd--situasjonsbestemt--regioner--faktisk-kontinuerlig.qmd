---
title: "DiD | Midl. lønnstilskudd | Situasjonsbestemt | Faktisk | Kontinuerlig"
execute:
  echo: false
  warning: false
---
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        0.0662 |           0.5996 |    0.11  |           0.908 |            0.9141 | [-1.2536, 1.3860] |    720 |         12 |
| Sesongjustert |       -0.4259 |           0.5713 |   -0.745 |           0.449 |            0.4716 | [-1.6834, 0.8316] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 10.2 % — koeffisienten tilsvarer en relativ endring på -4.2 %.  
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 14.30, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -0.7966 til -0.0491 når én region utelates.
...
| Modell        |   Koeffisient |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |       -0.2662 |           1.4202 |   -0.187 |           0.845 |            0.8547 | [-3.3922, 2.8597] |    720 |         12 |
| Sesongjustert |       -1.8268 |           1.2713 |   -1.437 |           0.24  |            0.1786 | [-4.6248, 0.9713] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 27.5 % — koeffisienten tilsvarer en relativ endring på -6.6 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±3.91 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 16.87, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -2.5823 til -1.0861 når én region utelates.
