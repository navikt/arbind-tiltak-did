---
title: "DiD | Midl. lønnstilskudd | Situasjonsbestemt | Forventet | Kontinuerlig"
execute:
  echo: false
  warning: false
---
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |       -0.1966 |           0.4436 |   -0.443 |           0.646 |            0.6662 | [-1.1728, 0.7797] |    720 |         12 |
| Sesongjustert |       -0.16   |           0.4623 |   -0.346 |           0.735 |            0.7359 | [-1.1776, 0.8577] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 10.0 % — koeffisienten tilsvarer en relativ endring på -1.6 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±1.42 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 4.93, p = 0.007), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -0.4244 til 0.2758 når én region utelates.
...
| Modell        |   Koeffisient |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |       -0.4707 |           1.0883 |   -0.432 |           0.661 |            0.6737 | [-2.8661, 1.9247] |    720 |         12 |
| Sesongjustert |       -0.4328 |           1.1722 |   -0.369 |           0.75  |            0.719  | [-3.0128, 2.1473] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 26.4 % — koeffisienten tilsvarer en relativ endring på -1.6 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±3.61 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 17.58, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -0.9847 til 0.9386 når én region utelates.
