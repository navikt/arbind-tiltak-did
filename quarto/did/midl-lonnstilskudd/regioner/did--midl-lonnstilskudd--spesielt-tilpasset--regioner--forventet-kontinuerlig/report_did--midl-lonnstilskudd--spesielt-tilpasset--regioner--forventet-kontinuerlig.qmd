---
title: "DiD | Midl. lønnstilskudd | Spesielt tilpasset | Forventet | Kontinuerlig"
execute:
  echo: false
  warning: false
---
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |       -0.2738 |           0.1512 |   -1.811 |           0.147 |            0.0975 | [-0.6065, 0.0590] |    720 |         12 |
| Sesongjustert |       -0.2418 |           0.1395 |   -1.733 |           0.197 |            0.111  | [-0.5489, 0.0653] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 7.1 % — koeffisienten tilsvarer en relativ endring på -3.4 %.  
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 3.71, p = 0.021), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -0.2951 til -0.1423 når én region utelates.
...
| Modell        |   Koeffisient |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |       -0.5609 |           0.3702 |   -1.515 |           0.186 |            0.1579 | [-1.3756, 0.2539] |    720 |         12 |
| Sesongjustert |       -0.4852 |           0.3496 |   -1.388 |           0.245 |            0.1927 | [-1.2548, 0.2844] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 16.5 % — koeffisienten tilsvarer en relativ endring på -2.9 %.  
...
Det er **ikke** statistisk grunnlag for å forkaste parallelle trender (F(10,11) = 1.54, p = 0.243, sesongjustert modell).
...
Sesongjustert modell: koeffisienten varierer mellom -0.6204 til -0.2375 når én region utelates.
