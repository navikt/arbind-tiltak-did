---
title: "DiD | Midl. lønnstilskudd | Veiledning kombinert | Kontinuerlig"
execute:
  echo: false
  warning: false
---
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        0.0862 |           0.0616 |    1.399 |           0.162 |            0.1895 | [-0.0494, 0.2217] |    720 |         12 |
| Sesongjustert |       -0.1727 |           0.1154 |   -1.497 |           0.134 |            0.1626 | [-0.4265, 0.0812] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** -0.1 % — koeffisienten tilsvarer en relativ endring på 155.4 %.  
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 4.37, p = 0.012), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -0.3228 til -0.1052 når én region utelates.
...
| Modell        | Koeffisient   |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|:--------------|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         | 0.2082        |           0.1948 |    1.068 |           0.299 |            0.3083 | [-0.2207, 0.6370] |    720 |         12 |
| Sesongjustert | -0.6900**     |           0.3366 |   -2.05  |           0.013 |            0.065  | [-1.4310, 0.0509] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** -0.0 % — koeffisienten tilsvarer en relativ endring på 4084.8 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±1.04 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 22.11, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -1.1270 til -0.5310 når én region utelates.
