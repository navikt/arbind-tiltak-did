---
title: "DiD | Alle tiltak | Veiledning kombinert | Forventet | Kontinuerlig (Enheter)"
execute:
  echo: false
  warning: false
---
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |       -0.6474 |           0.6506 |   -0.995 |           0.351 |            0.3411 | [-2.0794, 0.7846] |  12928 |         12 |
| Sesongjustert |       -0.4801 |           0.712  |   -0.674 |           0.545 |            0.514  | [-2.0472, 1.0870] |  12885 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 8.2 % — koeffisienten tilsvarer en relativ endring på -5.9 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±2.19 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(11,11) = 578.73, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -1.0971 til 0.0595 når én region utelates.
...
| Modell        |   Koeffisient |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |       -1.3714 |           1.8107 |   -0.757 |           0.471 |            0.4647 | [-5.3568, 2.6140] |  12928 |         12 |
| Sesongjustert |       -0.8072 |           2.0123 |   -0.401 |           0.707 |            0.696  | [-5.2362, 3.6219] |  12885 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 19.8 % — koeffisienten tilsvarer en relativ endring på -4.1 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±6.19 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(11,11) = 445.74, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -2.4979 til 0.5572 når én region utelates.
