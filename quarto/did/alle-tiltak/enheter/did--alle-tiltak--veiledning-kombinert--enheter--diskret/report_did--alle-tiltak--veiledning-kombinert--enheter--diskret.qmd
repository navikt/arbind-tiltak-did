---
title: "DiD | Alle tiltak | Veiledning kombinert | Diskret (Enheter)"
execute:
  echo: false
  warning: false
---
...
Sesongjustert modell — placebo-koeffisienten er -1.5021 (p = 0.228). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
...
Sesongjustert modell — placebo-koeffisienten er -6.7899 (p = 0.069). **Advarsel:** placebo-estimatet er signifikant, noe som kan indikere pre-eksisterende trender.
