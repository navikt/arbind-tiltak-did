---
title: "DiD | Alle tiltak | Veiledning kombinert | Forventet | Diskret (Enheter)"
execute:
  echo: false
  warning: false
---
...
Sesongjustert modell — placebo-koeffisienten er 2.7070 (p = 0.119). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
...
Sesongjustert modell — placebo-koeffisienten er 8.3070 (p = 0.109). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
