---
title: "DiD | Alle tiltak | Alle | Faktisk | Kontinuerlig (Enheter)"
execute:
  echo: false
  warning: false
---
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        0.2206 |           0.7547 |    0.292 |           0.824 |            0.7755 | [-1.4405, 1.8817] |  14643 |         12 |
| Sesongjustert |       -0.0791 |           0.816  |   -0.097 |           0.926 |            0.9245 | [-1.8751, 1.7168] |  14643 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 9.2 % — koeffisienten tilsvarer en relativ endring på -0.9 %.  
...
**Advarsel:** pre-trend-testen er signifikant (F(11,11) = 274.95, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er -4.1245 (p = 0.227). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
...
Sesongjustert modell: koeffisienten varierer mellom -0.7772 til 0.3895 når én region utelates.
...
| Modell        |   Koeffisient |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        0.4638 |           2.2363 |    0.207 |           0.889 |            0.8395 | [-4.4582, 5.3857] |  14643 |         12 |
| Sesongjustert |       -0.072  |           2.5699 |   -0.028 |           0.977 |            0.9782 | [-5.7283, 5.5843] |  14643 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 23.3 % — koeffisienten tilsvarer en relativ endring på -0.3 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±7.91 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(11,11) = 7555.93, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er -11.2499 (p = 0.241). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
...
Sesongjustert modell: koeffisienten varierer mellom -2.2755 til 1.2385 når én region utelates.
