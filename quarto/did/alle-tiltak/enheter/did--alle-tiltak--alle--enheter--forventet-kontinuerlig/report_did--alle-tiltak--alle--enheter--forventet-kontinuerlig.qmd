---
title: "DiD | Alle tiltak | Alle | Forventet | Kontinuerlig (Enheter)"
execute:
  echo: false
  warning: false
---
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |       -0.0515 |           0.7824 |   -0.066 |           0.956 |            0.9487 | [-1.7735, 1.6705] |  14643 |         12 |
| Sesongjustert |        0.3021 |           0.8401 |    0.36  |           0.719 |            0.726  | [-1.5469, 2.1511] |  14643 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 9.2 % — koeffisienten tilsvarer en relativ endring på 3.3 %.  
...
**Advarsel:** pre-trend-testen er signifikant (F(11,11) = 31020.77, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -0.2519 til 1.0082 når én region utelates.
...
| Modell        |   Koeffisient |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |       -0.142  |           1.8873 |   -0.075 |           0.946 |            0.9414 | [-4.2959, 4.0120] |  14643 |         12 |
| Sesongjustert |        1.0206 |           2.1449 |    0.476 |           0.643 |            0.6435 | [-3.7004, 5.7416] |  14643 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 22.8 % — koeffisienten tilsvarer en relativ endring på 4.5 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±6.60 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(11,11) = 47858.44, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -0.2691 til 2.7691 når én region utelates.
