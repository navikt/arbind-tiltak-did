---
title: "DiD | Alle tiltak | Veiledning kombinert | Kontinuerlig"
execute:
  echo: false
  warning: false
---
...
| Tiltaksnedgang (0–1) |          0.002 |       0.013 |    0     |     0.191 |
| Tiltak (antall)      |       5475.15  |    2066.55  | 2378.17  | 10984.6   |

**Behandlingsvariabel per region (gjennomsnitt i post-perioden):**

| Region                   |   Gj.snitt nedgang (0–1) |
|:-------------------------|-------------------------:|
| Nav Møre og Romsdal      |                    0.138 |
| Nav Oslo                 |                    0.058 |
| Nav Vestland             |                    0.044 |
| Nav Rogaland             |                    0.034 |
| Nav Øst-Viken            |                    0.024 |
| Nav Agder                |                    0.021 |
| Nav Troms og Finnmark    |                    0.009 |
| Nav Vest-Viken           |                    0.009 |
| Nav Trøndelag            |                    0.003 |
| Nav Innlandet            |                    0.003 |
| Nav Nordland             |                    0     |
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        0.5721 |           0.3355 |    1.705 |           0.559 |            0.1162 | [-0.1664, 1.3106] |  12875 |         12 |
| Sesongjustert |       -0.4837 |           0.5047 |   -0.959 |           0.234 |            0.3584 | [-1.5945, 0.6270] |  12847 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** -0.0 % — koeffisienten tilsvarer en relativ endring på 1075.0 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±1.55 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(11,11) = 270.86, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er -0.5543 (p = 0.626). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
...
Sesongjustert modell: koeffisienten varierer mellom -1.8363 til -0.3107 når én region utelates.
...
| Modell        |   Koeffisient |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        3.3132 |           1.7484 |    1.895 |           0.607 |            0.0847 | [-0.5351, 7.1615] |  12875 |         12 |
| Sesongjustert |       -0.2378 |           2.9989 |   -0.079 |           0.963 |            0.9382 | [-6.8382, 6.3627] |  12847 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 0.2 % — koeffisienten tilsvarer en relativ endring på -145.2 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±9.23 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(11,11) = 130.73, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er -5.5458 (p = 0.169). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
...
Sesongjustert modell: koeffisienten varierer mellom -9.3255 til 0.8113 når én region utelates.
