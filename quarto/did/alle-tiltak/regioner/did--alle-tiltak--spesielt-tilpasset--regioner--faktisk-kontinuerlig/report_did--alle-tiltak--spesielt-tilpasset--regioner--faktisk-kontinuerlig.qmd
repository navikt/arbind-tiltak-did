---
title: "DiD | Alle tiltak | Spesielt tilpasset | Faktisk | Kontinuerlig"
execute:
  echo: false
  warning: false
---
...
|:--------------|:--------------|-----------------:|---------:|----------------:|------------------:|:-------------------|-------:|-----------:|
| Basis         | -0.7095*      |           0.3079 |   -2.304 |           0.083 |            0.0417 | [-1.3872, -0.0317] |    720 |         12 |
| Sesongjustert | -0.9851**     |           0.3028 |   -3.253 |           0.029 |            0.0077 | [-1.6515, -0.3186] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 6.9 % — koeffisienten tilsvarer en relativ endring på -14.2 %.  
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 13.12, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -1.1882 til -0.8410 når én region utelates.
...
| Modell        | Koeffisient   |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI             |   Obs. |   Clustere |
|:--------------|:--------------|-----------------:|---------:|----------------:|------------------:|:-------------------|-------:|-----------:|
| Basis         | -1.7688*      |           0.7684 |   -2.302 |           0.087 |            0.0419 | [-3.4599, -0.0776] |    720 |         12 |
| Sesongjustert | -2.8907***    |           0.7201 |   -4.014 |           0.003 |            0.002  | [-4.4757, -1.3058] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 16.2 % — koeffisienten tilsvarer en relativ endring på -17.9 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±2.22 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 4.05, p = 0.015), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -3.3561 til -2.5007 når én region utelates.
