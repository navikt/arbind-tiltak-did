---
title: "DiD | Alle tiltak | Alle | Forventet | Kontinuerlig"
execute:
  echo: false
  warning: false
---
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |       -1.0201 |           0.9088 |   -1.122 |           0.244 |            0.2856 | [-3.0204, 0.9801] |    720 |         12 |
| Sesongjustert |       -0.9083 |           0.8139 |   -1.116 |           0.241 |            0.2883 | [-2.6997, 0.8832] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 8.8 % — koeffisienten tilsvarer en relativ endring på -10.4 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±2.50 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 10.20, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -1.5225 til -0.5448 når én region utelates.
...
| Modell        |   Koeffisient |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |       -2.5352 |           2.3656 |   -1.072 |           0.267 |            0.3068 | [-7.7419, 2.6715] |    720 |         12 |
| Sesongjustert |       -2.0734 |           2.1809 |   -0.951 |           0.328 |            0.3622 | [-6.8736, 2.7268] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 21.8 % — koeffisienten tilsvarer en relativ endring på -9.5 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±6.71 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 10.52, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -3.7793 til -1.1481 når én region utelates.
