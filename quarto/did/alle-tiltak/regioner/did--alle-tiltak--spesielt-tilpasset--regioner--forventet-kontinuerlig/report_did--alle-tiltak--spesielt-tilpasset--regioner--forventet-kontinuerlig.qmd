---
title: "DiD | Alle tiltak | Spesielt tilpasset | Forventet | Kontinuerlig"
execute:
  echo: false
  warning: false
---
...
|:--------------|:--------------|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         | -0.7372*      |           0.3985 |   -1.85  |           0.051 |            0.0914 | [-1.6143, 0.1399] |    720 |         12 |
| Sesongjustert | -0.5681       |           0.3741 |   -1.519 |           0.114 |            0.1571 | [-1.3916, 0.2553] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 7.1 % — koeffisienten tilsvarer en relativ endring på -8.0 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±1.15 pp.
...
Sesongjustert modell: koeffisienten varierer mellom -0.8203 til -0.4042 når én region utelates.
...
| Modell        | Koeffisient   |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|:--------------|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         | -1.5203*      |           0.9599 |   -1.584 |            0.08 |            0.1416 | [-3.6330, 0.5925] |    720 |         12 |
| Sesongjustert | -0.9968       |           0.9856 |   -1.011 |            0.28 |            0.3336 | [-3.1661, 1.1725] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 16.5 % — koeffisienten tilsvarer en relativ endring på -6.0 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±3.03 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 7.77, p = 0.001), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -1.7164 til -0.6206 når én region utelates.
