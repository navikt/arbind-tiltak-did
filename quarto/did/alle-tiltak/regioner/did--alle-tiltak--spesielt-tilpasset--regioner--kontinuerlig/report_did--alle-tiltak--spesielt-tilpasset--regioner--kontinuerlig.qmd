---
title: "DiD | Alle tiltak | Spesielt tilpasset | Kontinuerlig"
execute:
  echo: false
  warning: false
---
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        0.0287 |           0.2951 |    0.097 |           0.93  |            0.9242 | [-0.6208, 0.6783] |    720 |         12 |
| Sesongjustert |       -0.4155 |           0.2495 |   -1.666 |           0.189 |            0.124  | [-0.9645, 0.1335] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** -0.2 % — koeffisienten tilsvarer en relativ endring på 199.1 %.  
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 5.88, p = 0.004), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -0.6007 til -0.2611 når én region utelates.
...
| Modell        | Koeffisient   |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI             |   Obs. |   Clustere |
|:--------------|:--------------|-----------------:|---------:|----------------:|------------------:|:-------------------|-------:|-----------:|
| Basis         | -0.1422       |           0.9316 |   -0.153 |           0.904 |            0.8815 | [-2.1926, 1.9083]  |    720 |         12 |
| Sesongjustert | -1.7582*      |           0.6687 |   -2.629 |           0.061 |            0.0234 | [-3.2301, -0.2864] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** -0.4 % — koeffisienten tilsvarer en relativ endring på 459.2 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±2.06 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 3.20, p = 0.035), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -2.2854 til -1.4481 når én region utelates.
