---
title: "DiD | Alle tiltak | Spesielt tilpasset | Forventet | Diskret"
execute:
  echo: false
  warning: false
---
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |       -0.1156 |           0.0539 |   -2.145 |           0.159 |            0.0551 | [-0.2343, 0.0030] |    720 |         12 |
| Sesongjustert |       -0.0814 |           0.0481 |   -1.695 |           0.186 |            0.1182 | [-0.1872, 0.0243] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 7.1 % — koeffisienten tilsvarer en relativ endring på -1.1 %.  
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 2.49, p = 0.075), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er 1.0595 (p = 0.546). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
...
Sesongjustert modell: koeffisienten varierer mellom -0.1075 til -0.0571 når én region utelates.
...
|                 |   Gjennomsnitt |   Std.avvik |      Min |      Maks |
|:----------------|---------------:|------------:|---------:|----------:|
| jobb3           |         16.557 |       1.553 |   12.878 |    20.638 |
| Behandlet (0/1) |          0.097 |       0.296 |    0     |     1     |
| Tiltak (antall) |       5327.72  |    1984.91  | 2369.59  | 10816.6   |
...
| Modell        |   Koeffisient |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |       -0.263  |           0.1293 |   -2.034 |           0.165 |            0.0668 | [-0.5475, 0.0215] |    720 |         12 |
| Sesongjustert |       -0.1604 |           0.1109 |   -1.445 |           0.193 |            0.1762 | [-0.4045, 0.0838] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 16.5 % — koeffisienten tilsvarer en relativ endring på -1.0 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±0.34 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 2.68, p = 0.061), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er 2.0002 (p = 0.696). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
...
Sesongjustert modell: koeffisienten varierer mellom -0.2236 til -0.1014 når én region utelates.
