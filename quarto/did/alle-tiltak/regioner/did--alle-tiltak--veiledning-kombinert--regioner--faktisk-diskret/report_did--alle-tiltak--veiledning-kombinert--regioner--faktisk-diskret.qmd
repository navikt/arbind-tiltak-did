---
title: "DiD | Alle tiltak | Veiledning kombinert | Faktisk | Diskret"
execute:
  echo: false
  warning: false
---
...
|:--------------|:--------------|-----------------:|---------:|----------------:|------------------:|:-------------------|-------:|-----------:|
| Basis         | -0.3011*      |           0.0856 |   -3.519 |           0.099 |            0.0048 | [-0.4894, -0.1128] |    720 |         12 |
| Sesongjustert | -0.3278       |           0.0944 |   -3.472 |           0.104 |            0.0052 | [-0.5355, -0.1200] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 7.8 % — koeffisienten tilsvarer en relativ endring på -4.2 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±0.29 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 12.58, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er 0.6563 (p = 0.868). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
...
Sesongjustert modell: koeffisienten varierer mellom -0.3858 til -0.2697 når én region utelates.
...
|                 |   Gjennomsnitt |   Std.avvik |      Min |      Maks |
|:----------------|---------------:|------------:|---------:|----------:|
| jobb3           |         19.009 |       1.943 |   14.805 |    24.371 |
| Behandlet (0/1) |          0.097 |       0.296 |    0     |     1     |
| Tiltak (antall) |       5327.72  |    1984.91  | 2369.59  | 10816.6   |
...
| Modell        | Koeffisient   |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI             |   Obs. |   Clustere |
|:--------------|:--------------|-----------------:|---------:|----------------:|------------------:|:-------------------|-------:|-----------:|
| Basis         | -0.7568       |           0.2287 |   -3.309 |           0.105 |            0.007  | [-1.2601, -0.2534] |    720 |         12 |
| Sesongjustert | -0.8883*      |           0.2519 |   -3.527 |           0.097 |            0.0047 | [-1.4426, -0.3339] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 19.1 % — koeffisienten tilsvarer en relativ endring på -4.7 %.  
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 13.06, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er -0.3435 (p = 0.977). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
...
Sesongjustert modell: koeffisienten varierer mellom -1.0461 til -0.7249 når én region utelates.
