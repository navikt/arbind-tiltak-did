---
title: "DiD | Alle tiltak | Spesielt tilpasset | Faktisk | Diskret"
execute:
  echo: false
  warning: false
---
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |       -0.0935 |           0.0463 |   -2.021 |           0.167 |            0.0683 | [-0.1954, 0.0083] |    720 |         12 |
| Sesongjustert |       -0.0964 |           0.0468 |   -2.06  |           0.163 |            0.0638 | [-0.1994, 0.0066] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 6.9 % — koeffisienten tilsvarer en relativ endring på -1.4 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±0.14 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 33.47, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er 1.1110 (p = 0.526). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
...
Sesongjustert modell: koeffisienten varierer mellom -0.1197 til -0.0716 når én region utelates.
...
| Modell        |   Koeffisient |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |       -0.1195 |           0.1094 |   -1.092 |           0.232 |            0.2981 | [-0.3602, 0.1213] |    720 |         12 |
| Sesongjustert |       -0.1661 |           0.1249 |   -1.33  |           0.207 |            0.2105 | [-0.4409, 0.1088] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 16.2 % — koeffisienten tilsvarer en relativ endring på -1.0 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±0.38 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 10.08, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er -0.1011 (p = 0.983). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
...
Sesongjustert modell: koeffisienten varierer mellom -0.2276 til -0.1014 når én region utelates.
