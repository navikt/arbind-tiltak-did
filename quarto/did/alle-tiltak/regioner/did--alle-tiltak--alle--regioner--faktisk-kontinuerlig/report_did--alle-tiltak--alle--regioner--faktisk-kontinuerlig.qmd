---
title: "DiD | Alle tiltak | Alle | Faktisk | Kontinuerlig"
execute:
  echo: false
  warning: false
---
...
|:--------------|:--------------|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         | -0.7949       |           0.8185 |   -0.971 |           0.314 |            0.3523 | [-2.5964, 1.0066] |    720 |         12 |
| Sesongjustert | -1.5436*      |           0.8199 |   -1.883 |           0.055 |            0.0864 | [-3.3482, 0.2609] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 8.8 % — koeffisienten tilsvarer en relativ endring på -17.6 %.  
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 4.38, p = 0.011), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -2.0980 til -1.0618 når én region utelates.
...
| Modell        | Koeffisient   |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI             |   Obs. |   Clustere |
|:--------------|:--------------|-----------------:|---------:|----------------:|------------------:|:-------------------|-------:|-----------:|
| Basis         | -2.3476       |           1.9873 |   -1.181 |           0.222 |            0.2624 | [-6.7217, 2.0265]  |    720 |         12 |
| Sesongjustert | -4.7495**     |           2.0929 |   -2.269 |           0.025 |            0.0444 | [-9.3560, -0.1430] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 22.2 % — koeffisienten tilsvarer en relativ endring på -21.4 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±6.44 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 9.47, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -6.4503 til -3.6300 når én region utelates.
