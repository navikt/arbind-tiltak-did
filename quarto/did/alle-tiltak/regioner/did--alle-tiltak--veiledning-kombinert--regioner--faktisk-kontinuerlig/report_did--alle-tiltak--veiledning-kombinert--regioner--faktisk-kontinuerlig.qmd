---
title: "DiD | Alle tiltak | Veiledning kombinert | Faktisk | Kontinuerlig"
execute:
  echo: false
  warning: false
---
...
|:--------------|:--------------|-----------------:|---------:|----------------:|------------------:|:-------------------|-------:|-----------:|
| Basis         | -1.5079*      |           0.8265 |   -1.824 |           0.096 |            0.0953 | [-3.3270, 0.3112]  |    720 |         12 |
| Sesongjustert | -2.0976**     |           0.8561 |   -2.45  |           0.04  |            0.0322 | [-3.9818, -0.2134] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 7.8 % — koeffisienten tilsvarer en relativ endring på -27.0 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±2.63 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 25.43, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -2.7129 til -1.6041 når én region utelates.
...
| Modell        | Koeffisient   |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI              |   Obs. |   Clustere |
|:--------------|:--------------|-----------------:|---------:|----------------:|------------------:|:--------------------|-------:|-----------:|
| Basis         | -4.3791*      |           2.2233 |   -1.97  |           0.067 |            0.0746 | [-9.2725, 0.5142]   |    720 |         12 |
| Sesongjustert | -6.3022**     |           2.4982 |   -2.523 |           0.022 |            0.0283 | [-11.8007, -0.8037] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 19.1 % — koeffisienten tilsvarer en relativ endring på -33.0 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±7.69 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 21.30, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -8.3450 til -4.9244 når én region utelates.
