---
title: "DiD | Alle tiltak | Veiledning kombinert | Forventet | Diskret"
execute:
  echo: false
  warning: false
---
...
|:--------------|:--------------|-----------------:|---------:|----------------:|------------------:|:-------------------|-------:|-----------:|
| Basis         | -0.2917       |           0.0858 |   -3.398 |           0.104 |            0.0059 | [-0.4807, -0.1028] |    720 |         12 |
| Sesongjustert | -0.2539*      |           0.0738 |   -3.438 |           0.098 |            0.0055 | [-0.4164, -0.0914] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 7.9 % — koeffisienten tilsvarer en relativ endring på -3.2 %.  
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 4.61, p = 0.009), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er 1.2725 (p = 0.660). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
...
Sesongjustert modell: koeffisienten varierer mellom -0.2998 til -0.2101 når én region utelates.
...
| Modell        | Koeffisient   |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI             |   Obs. |   Clustere |
|:--------------|:--------------|-----------------:|---------:|----------------:|------------------:|:-------------------|-------:|-----------:|
| Basis         | -0.7940*      |           0.2198 |   -3.613 |           0.096 |            0.0041 | [-1.2777, -0.3102] |    720 |         12 |
| Sesongjustert | -0.6840*      |           0.1944 |   -3.519 |           0.093 |            0.0048 | [-1.1118, -0.2561] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 19.1 % — koeffisienten tilsvarer en relativ endring på -3.6 %.  
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 4.90, p = 0.007), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er 3.5675 (p = 0.683). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
...
Sesongjustert modell: koeffisienten varierer mellom -0.8025 til -0.5672 når én region utelates.
