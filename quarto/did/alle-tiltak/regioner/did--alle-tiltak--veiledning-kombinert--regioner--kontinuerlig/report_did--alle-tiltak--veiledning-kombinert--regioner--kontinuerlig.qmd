...
|:--------------|:--------------|-----------------:|---------:|----------------:|------------------:|:-------------------|-------:|-----------:|
| Basis         | -0.0438       |           0.2206 |   -0.199 |           0.891 |            0.8462 | [-0.5292, 0.4417]  |    720 |         12 |
| Sesongjustert | -0.7811**     |           0.2181 |   -3.582 |           0.019 |            0.0043 | [-1.2611, -0.3011] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** -0.1 % — koeffisienten tilsvarer en relativ endring på 703.0 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±0.67 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 7.67, p = 0.001), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -0.9357 til -0.6993 når én region utelates.
...
| Modell        | Koeffisient   |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI             |   Obs. |   Clustere |
|:--------------|:--------------|-----------------:|---------:|----------------:|------------------:|:-------------------|-------:|-----------:|
| Basis         | -0.5931       |           0.5258 |   -1.128 |           0.425 |            0.2834 | [-1.7504, 0.5643]  |    720 |         12 |
| Sesongjustert | -3.0553***    |           0.7392 |   -4.133 |           0.004 |            0.0017 | [-4.6823, -1.4284] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** -0.0 % — koeffisienten tilsvarer en relativ endring på 18086.3 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±2.27 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 8.45, p = 0.001), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -3.6770 til -2.7784 når én region utelates.
