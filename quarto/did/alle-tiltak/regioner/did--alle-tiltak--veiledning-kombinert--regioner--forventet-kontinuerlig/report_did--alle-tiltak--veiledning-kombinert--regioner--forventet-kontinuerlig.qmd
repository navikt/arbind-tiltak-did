---
title: "DiD | Alle tiltak | Veiledning kombinert | Forventet | Kontinuerlig"
execute:
  echo: false
  warning: false
---
...
|:--------------|:--------------|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         | -1.4634*      |           0.8586 |   -1.704 |           0.077 |            0.1164 | [-3.3533, 0.4264] |    720 |         12 |
| Sesongjustert | -1.3155       |           0.8178 |   -1.609 |           0.103 |            0.136  | [-3.1155, 0.4845] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 7.9 % — koeffisienten tilsvarer en relativ endring på -16.7 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±2.52 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 5.31, p = 0.005), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -1.9313 til -0.9008 når én region utelates.
...
| Modell        | Koeffisient   |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|:--------------|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         | -3.6827*      |           2.3339 |   -1.578 |           0.098 |            0.1429 | [-8.8196, 1.4543] |    720 |         12 |
| Sesongjustert | -3.1296       |           2.2968 |   -1.363 |           0.153 |            0.2003 | [-8.1850, 1.9257] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 19.1 % — koeffisienten tilsvarer en relativ endring på -16.4 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±7.07 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 3.29, p = 0.032), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -4.7749 til -2.0291 når én region utelates.
