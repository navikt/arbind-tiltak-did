...
- Antall enheter: **245**
- Antall måneder: **60**
- Behandlet gruppe (Veiledning kombinert, n): **13915**
- Kontrollgruppe (Standard, n): **14025**

**Gjennomsnittlig indikatorverdi i pre-perioden:**

| Gruppe | Gjennomsnitt |
|:--|--:|
| Veiledning kombinert (behandlet) | -0.0450 |
| Standard (kontroll) | 0.9914 |
| Differanse | -1.0364 |

I pre-perioden lå Veiledning kombinert i gjennomsnitt **1.0364** poeng
...
| Gruppe | Gjennomsnitt |
|:--|--:|
| Veiledning kombinert (behandlet) | 0.1637 |
| Standard (kontroll) | 2.9518 |
| Differanse | -2.7880 |

I pre-perioden lå Veiledning kombinert i gjennomsnitt **2.7880** poeng
