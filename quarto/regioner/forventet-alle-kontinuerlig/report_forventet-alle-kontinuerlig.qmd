---
title: "DiD-analyse for alle, forventet"
lang: nb
format:
  html:
    toc: true
...
|:---------------------|---------------:|------------:|--------:|---------:|
| atid3                |          8.484 |       0.889 |   6.657 |   10.503 |
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |       -0.1879 |           0.4068 |   -0.462 |           0.634 |            0.6531 | [-1.0832, 0.7073] |    720 |         12 |
| Sesongjustert |       -0.0984 |           0.3934 |   -0.25  |           0.839 |            0.807  | [-0.9642, 0.7673] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 8.5 % — koeffisienten tilsvarer en relativ endring på -1.2 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±1.21 pp.
...
Sesongjustert modell — placebo-koeffisienten er 0.7054 (p = 0.148). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
...
Sesongjustert modell: koeffisienten varierer mellom -0.2720 til 0.2898 når én region utelates.
...
|                      |   Gjennomsnitt |   Std.avvik |    Min |     Maks |
|:---------------------|---------------:|------------:|-------:|---------:|
| jobb3                |         21.205 |       2.52  |  16.67 |   28.017 |
| Tiltaksnedgang (0–1) |          0.021 |       0.092 |   0    |    0.69  |
| Tiltak (antall)      |        593.907 |     224.287 | 134    | 1224     |
...
| Modell        |   Koeffisient |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |       -0.5254 |           1.056  |   -0.498 |           0.616 |            0.6286 | [-2.8496, 1.7988] |    720 |         12 |
| Sesongjustert |       -0.3741 |           1.0967 |   -0.341 |           0.78  |            0.7395 | [-2.7879, 2.0398] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 21.3 % — koeffisienten tilsvarer en relativ endring på -1.8 %.  
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 4.25, p = 0.013), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er 1.7957 (p = 0.154). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
...
Sesongjustert modell: koeffisienten varierer mellom -0.8529 til 0.7047 når én region utelates.
