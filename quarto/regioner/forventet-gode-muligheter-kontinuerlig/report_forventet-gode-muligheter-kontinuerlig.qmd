---
title: "Innsatsgruppen 'Standard', kontinuerlig, forventet"
execute:
  echo: false
  warning: false
---
...
|:---------------------|---------------:|------------:|--------:|---------:|
| atid3                |         12.411 |       1.81  |   8.467 |   17.032 |
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        0.7857 |           0.7469 |    1.052 |           0.283 |            0.3154 | [-0.8582, 2.4296] |    720 |         12 |
| Sesongjustert |        0.8162 |           0.6891 |    1.184 |           0.276 |            0.2612 | [-0.7005, 2.3328] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 12.6 % — koeffisienten tilsvarer en relativ endring på 6.5 %.
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±2.12 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 2.35, p = 0.089), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er 0.5544 (p = 0.495). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
...
Sesongjustert modell: koeffisienten varierer mellom 0.4021 til 1.2829 når én region utelates.
...
|                      |   Gjennomsnitt |   Std.avvik |     Min |     Maks |
|:---------------------|---------------:|------------:|--------:|---------:|
| jobb3                |         34.154 |       4.742 |  24.086 |   46.886 |
| Tiltaksnedgang (0–1) |          0.021 |       0.092 |   0     |    0.69  |
| Tiltak (antall)      |        593.907 |     224.287 | 134     | 1224     |
...
| Modell        |   Koeffisient |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        2.3088 |           2.0908 |    1.104 |           0.294 |            0.2931 | [-2.2930, 6.9106] |    720 |         12 |
| Sesongjustert |        2.0866 |           2.1811 |    0.957 |           0.384 |            0.3593 | [-2.7140, 6.8872] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 34.5 % — koeffisienten tilsvarer en relativ endring på 6.0 %.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 2.69, p = 0.060), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er 1.6495 (p = 0.484). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
...
Sesongjustert modell: koeffisienten varierer mellom 0.8166 til 3.4277 når én region utelates.
