---
title: "DiD-analyse for innsatsgruppen 'nedsatt arbeidsevne' (diskret)"
lang: nb
format:
  html:
    toc: true
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |       -0.0073 |           0.049  |   -0.149 |           0.856 |            0.8842 | [-0.1152, 0.1006] |    720 |         12 |
| Sesongjustert |       -0.0277 |           0.0474 |   -0.585 |           0.675 |            0.5704 | [-0.1319, 0.0765] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** -0.2 % — koeffisienten tilsvarer en relativ endring på 14.1 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±0.15 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 3.59, p = 0.024), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -0.0816 til 0.0262 når én region utelates.
...
| Modell        |   Koeffisient |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        0.0886 |           0.2426 |    0.365 |           0.721 |            0.722  | [-0.4455, 0.6226] |    720 |         12 |
| Sesongjustert |       -0.0131 |           0.2259 |   -0.058 |           0.943 |            0.9547 | [-0.5103, 0.4841] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** -0.4 % — koeffisienten tilsvarer en relativ endring på 3.7 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±0.69 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 14.44, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell: koeffisienten varierer mellom -0.2850 til 0.2587 når én region utelates.
