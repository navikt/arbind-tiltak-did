---
title: "Innsatsgruppen 'Standard', kontinuerlig, faktisk"
execute:
  echo: false
  warning: false
---
...
|:---------------------|---------------:|------------:|--------:|---------:|
| atid3                |         13.328 |       2.336 |   7.938 |   19.907 |
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        2.0062 |           1.1531 |    1.74  |           0.159 |            0.1098 | [-0.5318, 4.5442] |    720 |         12 |
| Sesongjustert |        1.3395 |           1.182  |    1.133 |           0.23  |            0.2812 | [-1.2621, 3.9411] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 13.5 % — koeffisienten tilsvarer en relativ endring på 9.9 %.
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±3.64 pp.
...
Det er **ikke** statistisk grunnlag for å forkaste parallelle trender (F(10,11) = 1.60, p = 0.227, sesongjustert modell).
...
Sesongjustert modell — placebo-koeffisienten er 1.3864 (p = 0.214). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
...
Sesongjustert modell: koeffisienten varierer mellom 0.5624 til 1.9955 når én region utelates.
...
|                      |   Gjennomsnitt |   Std.avvik |     Min |     Maks |
|:---------------------|---------------:|------------:|--------:|---------:|
| jobb3                |         36.879 |       6.345 |  21.318 |   55.528 |
| Tiltaksnedgang (0–1) |          0.021 |       0.092 |   0     |    0.69  |
| Tiltak (antall)      |        593.907 |     224.287 | 134     | 1224     |
...
| Modell        | Koeffisient   |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI             |   Obs. |   Clustere |
|:--------------|:--------------|-----------------:|---------:|----------------:|------------------:|:-------------------|-------:|-----------:|
| Basis         | 8.6907*       |           3.4216 |    2.54  |           0.098 |            0.0275 | [1.1599, 16.2216]  |    720 |         12 |
| Sesongjustert | 5.6924        |           3.5931 |    1.584 |           0.133 |            0.1414 | [-2.2160, 13.6009] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 37.4 % — koeffisienten tilsvarer en relativ endring på 15.2 %.
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±11.05 pp.
...
Det er **ikke** statistisk grunnlag for å forkaste parallelle trender (F(10,11) = 1.84, p = 0.165, sesongjustert modell).
...
Sesongjustert modell — placebo-koeffisienten er 5.9723 (p = 0.065). **Advarsel:** placebo-estimatet er signifikant, noe som kan indikere pre-eksisterende trender.
...
Sesongjustert modell: koeffisienten varierer mellom 3.6227 til 7.9840 når én region utelates.
