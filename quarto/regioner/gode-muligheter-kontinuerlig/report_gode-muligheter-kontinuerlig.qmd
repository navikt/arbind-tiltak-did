---
title: "Innsatsgruppen 'Standard', kontinuerlig"
execute:
  echo: false
  warning: false
---
...
|:--------------|:--------------|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         | 1.2207*       |           0.4971 |    2.456 |           0.093 |            0.0319 | [0.1267, 2.3148]  |    720 |         12 |
| Sesongjustert | 0.5232        |           0.6035 |    0.867 |           0.359 |            0.4045 | [-0.8052, 1.8515] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 1.0 % — koeffisienten tilsvarer en relativ endring på 53.8 %.
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±1.86 pp.
...
Det er **ikke** statistisk grunnlag for å forkaste parallelle trender (F(10,11) = 0.37, p = 0.935, sesongjustert modell).
...
Sesongjustert modell: koeffisienten varierer mellom 0.1602 til 0.9460 når én region utelates.
...
| Modell        | Koeffisient   |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|:--------------|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         | 6.3417**      |           1.7772 |    3.568 |           0.045 |            0.0044 | [2.4302, 10.2533] |    720 |         12 |
| Sesongjustert | 3.5907        |           2.4315 |    1.477 |           0.119 |            0.1678 | [-1.7609, 8.9423] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 2.9 % — koeffisienten tilsvarer en relativ endring på 123.9 %.
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±7.48 pp.
...
Det er **ikke** statistisk grunnlag for å forkaste parallelle trender (F(10,11) = 1.86, p = 0.162, sesongjustert modell).
...
Sesongjustert modell: koeffisienten varierer mellom 1.8811 til 5.9002 når én region utelates.
