---
title: "DiD-analyse for innsatsgruppen 'nedsatt arbeidsevne', faktisk"
lang: nb
format:
  html:
    toc: true
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |       -0.1684 |           0.2625 |   -0.641 |           0.536 |            0.5344 | [-0.7462, 0.4094] |    720 |         12 |
| Sesongjustert |       -0.1453 |           0.2336 |   -0.622 |           0.535 |            0.5468 | [-0.6594, 0.3689] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 6.9 % — koeffisienten tilsvarer en relativ endring på -2.1 %.  
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 18.66, p = 0.000), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er -0.5629 (p = 0.123). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
...
Sesongjustert modell: koeffisienten varierer mellom -0.2507 til 0.0428 når én region utelates.
...
|                      |   Gjennomsnitt |   Std.avvik |     Min |     Maks |
|:---------------------|---------------:|------------:|--------:|---------:|
| jobb3                |         16.017 |       1.777 |  12.771 |   21.407 |
| Tiltaksnedgang (0–1) |          0.021 |       0.092 |   0     |    0.69  |
| Tiltak (antall)      |        593.907 |     224.287 | 134     | 1224     |
...
| Modell        |   Koeffisient |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |       -0.1996 |           0.75   |   -0.266 |           0.788 |             0.795 | [-1.8505, 1.4512] |    720 |         12 |
| Sesongjustert |       -0.3577 |           0.6774 |   -0.528 |           0.599 |             0.608 | [-1.8487, 1.1334] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 16.0 % — koeffisienten tilsvarer en relativ endring på -2.2 %.  
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±2.08 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 6.09, p = 0.003), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er -2.6036 (p = 0.011). **Advarsel:** placebo-estimatet er signifikant, noe som kan indikere pre-eksisterende trender.
...
Sesongjustert modell: koeffisienten varierer mellom -0.6583 til 0.2488 når én region utelates.
