---
title: "Innsatsgruppen 'Situasjonsbestemt', kontinuerlig, forventet"
execute:
  echo: false
  warning: false
---
...
|:---------------------|---------------:|------------:|--------:|---------:|
| atid3                |          9.636 |       1.094 |   7.207 |   12.556 |
...
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        0.0083 |           0.8781 |    0.009 |           0.992 |            0.9926 | [-1.9243, 1.9409] |    720 |         12 |
| Sesongjustert |        0.032  |           0.8933 |    0.036 |           0.971 |            0.9721 | [-1.9342, 1.9982] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 9.6 % — koeffisienten tilsvarer en relativ endring på 0.3 %.
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±2.75 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 6.39, p = 0.003), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er 1.1414 (p = 0.256). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
...
Sesongjustert modell: koeffisienten varierer mellom -0.3499 til 0.7291 når én region utelates.
...
|                      |   Gjennomsnitt |   Std.avvik |     Min |     Maks |
|:---------------------|---------------:|------------:|--------:|---------:|
| jobb3                |         25.469 |       2.91  |  19.498 |   33.111 |
| Tiltaksnedgang (0–1) |          0.021 |       0.092 |   0     |    0.69  |
| Tiltak (antall)      |        593.907 |     224.287 | 134     | 1224     |
...
| Modell        |   Koeffisient |   Std.feil (CR1) |   t-stat |   p (bootstrap) |   p (asymptotisk) | 95% KI            |   Obs. |   Clustere |
|:--------------|--------------:|-----------------:|---------:|----------------:|------------------:|:------------------|-------:|-----------:|
| Basis         |        0.0367 |           2.1416 |    0.017 |           0.988 |            0.9866 | [-4.6769, 4.7503] |    720 |         12 |
| Sesongjustert |       -0.0609 |           2.086  |   -0.029 |           0.978 |            0.9772 | [-4.6522, 4.5304] |    720 |         12 |

> **Signifikansnivå (bootstrap):** \* p < 0,10 &nbsp; \*\* p < 0,05 &nbsp; \*\*\* p < 0,01

**Gjennomsnittlig pre-periode-nivå:** 25.5 % — koeffisienten tilsvarer en relativ endring på -0.2 %.
**Minimum detekterbar effekt (80 % styrke, α = 0,05):** ±6.42 pp.
...
**Advarsel:** pre-trend-testen er signifikant (F(10,11) = 6.80, p = 0.002), noe som svekker DiD-antakelsen.
...
Sesongjustert modell — placebo-koeffisienten er 2.8385 (p = 0.264). Dette er ikke signifikant, noe som styrker identifikasjonsstrategien.
...
Sesongjustert modell: koeffisienten varierer mellom -0.9913 til 1.5813 når én region utelates.
